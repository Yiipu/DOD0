...
def good_morning(config_file, group, openid, location_id):
    import datetime
    today=datetime.datetime.now()
    special_day=datetime.datetime(2022, 9, 21)
    Config = load_json(config_file)
    morning_template=Config['templates']['morning'][group]
    hefeng_index_url, hefeng_3d_url, hefeng_key = Config['url']['hefeng_api']['index'], Config['url']['hefeng_api']['3d'], Config['key']['hefeng']
